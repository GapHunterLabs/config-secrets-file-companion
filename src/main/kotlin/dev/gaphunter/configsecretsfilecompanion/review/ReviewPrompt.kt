package dev.gaphunter.configsecretsfilecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.configsecretsfilecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.configsecretsfilecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Config Secrets File Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33799-config-secrets-file-companion/reviews"
